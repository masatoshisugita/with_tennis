              ...
              <div class="card-body mt-5">
                ...
                @endif
                  <form method="POST" action="{{ route('event.store') }}">
                      ...
                      <div class="form-group text-center">
                        <label for="date">日時<span class="text-danger"> (注)2020-11-10 12:00の形で入力してください</span></label>                          
                        <input id="date" type="datetime" class="form-control @error('date') is-invalid @enderror" 
                        placeholder="次のフォーマットで書いてください)　2020-11-10 11:00" name="date" value="{{ old('date') }}" required autocomplete="date">                          
                      </div>
